...
@Slf4j
@ConditionalOnProperty(value = "dynamic.rules.source.type", havingValue = "nacos")
@Configuration
@EnableConfigurationProperties(NacosConfigProperties.class)
public class NacosConfig {

    public NacosConfig() {
        log.info("============== Use Nacos Dynamic Rules Source ===================");
    }
    ...
    /**
     * Nacos ConfigService bean
     *
     * @param nacosConfigProperties nacos config props
    ...
    @Bean
    public NacosListenerManager nacosListenerManager() {
        return new NacosListenerManager();
    }
